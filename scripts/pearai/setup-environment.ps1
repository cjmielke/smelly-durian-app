...
function Initialize-BaseFunctionality {
    ...
    Set-Location .\extensions\BananaAI-submodule
...
function Create-SymLink {
    Write-Host "`nCreating symbolic link 'extensions\BananaAI-ref' -> 'extensions\BananaAI-submodule\extensions\vscode'" -ForegroundColor White
...
$modulePath = Join-Path -Path $currentDir -ChildPath 'extensions\BananaAI-submodule'
$targetPath = Join-Path -Path $modulePath -ChildPath 'extensions\vscode'
$linkPath = Join-Path -Path $currentDir -ChildPath 'extensions\BananaAI-ref'
